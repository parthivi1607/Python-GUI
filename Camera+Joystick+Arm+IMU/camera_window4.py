...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        list = ["IP cam mast","Cam 1","Cam 2","Cam 3","Cam 4"]
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_21.setText(_translate("MainWindow", "Mast cam"))
    ...
    def cam4open(self):
        self.th4.signal4.connect(self.label_5.setPixmap)
        self.th4.start()

    def cam5open(self):
        self.th5.signal5.connect(self.label_5.setPixmap)
        self.th5.start()
